...
export default function NoteEditIcon({ size, className }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      <path d="M15.9453 2V4M10.9453 2V4M5.94531 2V4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
