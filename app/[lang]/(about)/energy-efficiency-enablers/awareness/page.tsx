    ...
    <>
      ...
      <div className={'overflow-hidden bg-[#F7F8F7] pt-16'}>
        <div className='container relative'>
          <BookUploadIcon
            className={
              'absolute -bottom-40 end-4 left-0 z-0 size-96  opacity-5 md:opacity-25'
            }
          />
          <div className={'grid md:grid-cols-2'}>
            <div className={'mb-6'}>
              ...
              <p className={'mb-8 max-w-[600px] text-sub_p'}>
                ينظم المركز حملات توعية ويقدم برامج تثقيفية للمجتمع والقطاعات
                ذات الصلة، ويشارك في الفعاليات والمعارض لتعزيز الوعي بأهمية
                كفاءة الطاقة وتبني الممارسات الصديقة للبيئة والمستدامة.
              </p>
            </div>
          </div>
        </div>
